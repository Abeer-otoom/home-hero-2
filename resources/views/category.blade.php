...
<div class="hero-bg-image  flex flec-col items-center justify-center ">
    <h1 class="text-gray-100 text-5xl text-shadow uppercase font-bold pb-10">categories</h1>
          <a class="box bg-gray-100 text-gray-100 py-4 px-5 rounded-lg  font-bold uppercase text-xl" href="/tasker/create">becom tasker</a>
